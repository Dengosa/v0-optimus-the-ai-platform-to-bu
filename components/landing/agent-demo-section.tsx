...
import { ArrowRight, Check, Scale, GraduationCap, HeartPulse, CreditCard } from "lucide-react";
...
const scenarios: Scenario[] = [
  {
    ...
    steps: ["Passport status identified", "Immigration status reviewed", "Renewal pathway generated"],
    results: [
      { label: "Status", value: "Passport expired" },
      { label: "Risk level", value: "Medium" },
    ],
    actions: ["Passport renewal checklist", "Embassy contact template", "Required documents list"],
  ...
  },
  {
    ...
    steps: ["Career pathway generated", "Universities identified", "Bursaries found"],
    results: [
      { label: "Recommended universities", value: "4 matched" },
      { label: "Funding opportunities", value: "7 found" },
    ],
    actions: ["Recommended universities", "Estimated costs", "Application timeline"],
  ...
  },
  {
    ...
    steps: ["Documentation reviewed", "Similar case patterns identified", "Action plan generated"],
    results: [
      { label: "Status", value: "Identity documentation delay" },
      { label: "Risk level", value: "Medium" },
    ],
    actions: ["Home Affairs escalation pack", "Document checklist", "Follow-up timeline"],
...
export function AgentDemoSection() {
  ...
  const statusFor = (key: AgentKey): string => {
    if (key !== activeAgent) return phase >= 1 ? "Standby" : "Ready";
    if (phase <= 1) return "Ready";
    if (phase >= 2 && phase < 5) return "Processing";
    return "Complete";
  };
